...
<div id="container" style="height: 1800px" >
	...
	<div id="banner">
		<video muted="muted" ; autoplay="autoplay"; loop="loop">
                ...
                <source src="videos/Pizza.webm" type="video/webm">
        </video> 
	</div>
	<h1 style="position: relative;text-align: center;font-size: 50;font-family: Impact;color:#FF7C00">Welcome to Pizza Hut!!</h1>
